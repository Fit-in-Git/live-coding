    ...
    <div className="contentWrapper">
      ...
      <div className="teaser">
        <div className="teaser__box">
          <h2>
            Passgenau finanziert. Mit dem ausgezeichneten DCI Bank
            BaufinanzFinder.
          </h2>
          <p>
            Beste Beratung bei der Baufinanzierung mit dem "Finanzprodukt des
            Jahres": Mit uns über 300 Baufinanzierer vergleichen und das beste
            Angebot mit den besten Zinsen sichern. Finden Sie die
            Immobilienfinanzierung, die zu Ihnen passt! <br />
          ...
          <form action="">
            ...
            {register ? (
              <p className="register">
                <span onClick={() => setRegister(false)}>Zur Anmeldung</span>
              </p>
            ) : (
              <p className="register">
                Noch kein Konto?{" "}
